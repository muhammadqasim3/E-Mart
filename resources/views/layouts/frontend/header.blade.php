        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="javascript:void(0)"><img src="{{ asset('frontend_assets/images/logo.png') }}" class="logo" alt=""></a>
                </div>
                    ...
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                                        ...
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="javascript:void(0)">Sweaters & Cardigans</a></li>
                                        ...
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="javascript:void(0)">Party wear</a></li>
                                                    <li><a href="javascript:void(0)">Bottom Wear</a></li>
                                                    <li><a href="javascript:void(0)">Indian Wear</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-menu col-md-3">
                                            ...
                                            <div class="content">
                                                <ul class="menu-col">
                                                    ...
                                                    <li><a href="javascript:void(0)">Fragrances</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="javascript:void(0)">Shop Detail</a></li>
                            </ul>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="javascript:void(0)">Our Service</a></li>
